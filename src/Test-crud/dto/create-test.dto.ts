...
export class CreateTestDto {
  ...
  @ArrayMinSize(5)
  @ApiProperty({
    description: 'Conhecimento sistêmico da empresa. A capacidade da pessoa em conhecer e impactar os sistemas de tecnologia.',
    example:[
  ...
  @ArrayMinSize(5)
  @ApiProperty({
    description: 'Relacionamento da pessoa com outros dentro e fora da sua squad.',
    example:[
  ...
  @ArrayMinSize(5)
  @ApiProperty({
    description: 'Nível de engajamento da pessoa com os processos definidos pelo time de tecnologia.',
    example:[
  ...
  @ArrayMinSize(3)
  @ApiProperty({
    description: 'A importância de testes e os tipos de testes são as coisas buscadas nesses níveis.',
    example:[
  ...
  @ArrayMinSize(3)
  @ApiProperty({
    description: 'A capacidade da pessoa em estabelecer e difundir os fundamentos computacionais e, através deles, melhorar a qualidade do código são os atributos buscados nessa vertente.',
    example:[
